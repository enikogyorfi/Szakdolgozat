...
A független növekmények tulajdonságából adódóan a Brown-mozgás egy Gauss-Markov-folyamat. Továbbá, mivel az átmeneti sűrűsége csak az időbeli különbségtől függ, egyben időben homogén Markov-folyamat is.
Bár a Brown-mozgás trajektóriái folytonosak, de nem differenciálhatóak.

*Definíció* : Egy stem:[F:[a,b\] \to \mathbb{R}] függvényt akkor nevezünk Hölder-folytonosnak a stem:[[a,b]] intervallumon stem:[\gamma] kitevővel, ha stem:[0 < \gamma \le 1], és létezik egy stem:[C] állandó, melyre minden stem:[s,t \in [a,b]] esetén teljesül a következő egyenlőtlenség:

\[
|F(t) - F(s)| \le C|t-s|^{\gamma}
\]
