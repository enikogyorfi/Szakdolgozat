...
\begin{titlepage}
    ...
    {\large \scshape EÖTVÖS LORÁND UNIVERSITY \par}
    {\large \scshape FACULTY OF NATURAL SCIENCES \par}
    ...
    {\huge \bfseries MATHEMATICAL MODELS OF OPTION PRICING \par}
    ...
    % Ha van logód, vedd ki a kommentet az alábbi sorból:
    % \includegraphics[width=200pt]{elte_ttk_logo.png}\par\vspace{1cm}

    {\large Budapest, 2025 \par}
\end{titlepage}
